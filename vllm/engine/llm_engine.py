...
class LLMEngine:
    ...
    def from_engine_args(
        ...
        engine_config = engine_args.create_engine_config(usage_context)  # 包含一堆config, cache_config, compilation_config, decoding_config, device_config, load_config, lora_config, model_config, observability_config, parallel_config, prompt_adapter_config, quant_config, scheduler_config, speculative_config
